...
def get_dashboard():
    """Serves the 3-Sensor Telemetry & Flashing Alert UI Dashboard."""
    dashboard_path = os.path.join(AGENT_DIR, "app", "static", "dashboard.html")
    return FileResponse(dashboard_path)


@app.get("/api/sensors/telemetry")
def get_telemetry():
    """Generates random 3-sensor telemetry readings and evaluates threshold flags."""
    from app.agent import generate_sensor_telemetry
